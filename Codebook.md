...
The calculated means of the following measurements, grouped by SubjectID and Activity Name, are in 'tidy.txt'   
...
The complete list of measurements can be found in the original downloaded data - 'features.txt'    
